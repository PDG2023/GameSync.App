...
public class GetGameEndpoint : Endpoint<SingleGameRequest, Results<Ok<Game>, NotFound>>
{
    ...
    public override async Task<Results<Ok<Game>, NotFound>> ExecuteAsync(SingleGameRequest req, CancellationToken ct)
    {
